...
const frontmatter = {
  ...
  "tags": ["Role models", "Guidance", "Mentorship"],
...
function _createMdxContent(props) {
  ...
  return createVNode(Fragment, {
    children: [createVNode(_components.p, {
      children: ["We all need a role model or two. These are the people we often go to when we seek guidance or feeling down.", createVNode("br", {}), "\n", createVNode("small", {
...
const url = "src/content/premium_blog/role-model-1.mdx";
const file = "C:/Users/Lapane/Documents/Code/Astro/WPA_Blog/Wolfie/src/content/premium_blog/role-model-1.mdx";
...
Content.moduleId = "C:/Users/Lapane/Documents/Code/Astro/WPA_Blog/Wolfie/src/content/premium_blog/role-model-1.mdx";
